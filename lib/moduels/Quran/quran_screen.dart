...
class _QuranScreenState extends State<QuranScreen> {
  ...
  final List<SuraDataModel> suraList = [
    ...
    SuraDataModel(
        ...
        suraNameEN: "An-Nisa",
        suraNameAR: "النساء",
        versesNumber: "176 Verses"),
    SuraDataModel(
        id: "5",
        suraNameEN: "Al-Ma'idah",
        suraNameAR: "المائدة",
        versesNumber: "120 Verses"),
    SuraDataModel(
        id: "6",
        suraNameEN: "Al-An'am",
        suraNameAR: "الأنعام",
        versesNumber: "165 Verses"),
    SuraDataModel(
        id: "7",
        suraNameEN: "Al-A'raf",
        suraNameAR: "الأعراف",
        versesNumber: "206 Verses"),
    SuraDataModel(
        id: "8",
        suraNameEN: "Al-Anfal",
        suraNameAR: "الأنفال",
        versesNumber: "75 Verses"),
    SuraDataModel(
        id: "9",
        suraNameEN: "At-Tawbah",
        suraNameAR: "التوبة",
        versesNumber: "129 Verses"),
    SuraDataModel(
        id: "10",
        suraNameEN: "Yunus",
        suraNameAR: "يونس",
        versesNumber: "109 Verses"),
    SuraDataModel(
        id: "11",
        suraNameEN: "Hud",
        suraNameAR: "هود",
        versesNumber: "123 Verses"),
    SuraDataModel(
        id: "12",
        suraNameEN: "Yusuf",
        suraNameAR: "يوسف",
        versesNumber: "111 Verses"),
    SuraDataModel(
        id: "13",
        suraNameEN: "Ar-Ra'd",
        suraNameAR: "الرعد",
        versesNumber: "43 Verses"),
    SuraDataModel(
        id: "14",
        suraNameEN: "Ibrahim",
        suraNameAR: "إبراهيم",
        versesNumber: "52 Verses"),
    SuraDataModel(
        id: "15",
        suraNameEN: "Al-Hijr",
        suraNameAR: "الحجر",
        versesNumber: "99 Verses"),
    SuraDataModel(
        id: "16",
        suraNameEN: "An-Nahl",
        suraNameAR: "النحل",
        versesNumber: "128 Verses"),
    SuraDataModel(
        id: "17",
        suraNameEN: "Al-Isra",
        suraNameAR: "الإسراء",
    ...
    SuraDataModel(
        ...
        suraNameEN: "Al-Kahf",
        suraNameAR: "الكهف",
        versesNumber: "110 Verses"),
    SuraDataModel(
        id: "19",
        suraNameEN: "Maryam",
        suraNameAR: "مريم",
        versesNumber: "59 Verses"),
    SuraDataModel(
        id: "20",
        suraNameEN: "Ta-Ha",
        suraNameAR: "طه",
        versesNumber: "135 Verses"),
    SuraDataModel(
        id: "21",
        suraNameEN: "Al-Anbiya",
        suraNameAR: "الأنبياء",
        versesNumber: "112 Verses"),
    SuraDataModel(
        id: "22",
        suraNameEN: "Al-Hajj",
        suraNameAR: "الحج",
        versesNumber: "78 Verses"),
    SuraDataModel(
        id: "23",
        suraNameEN: "Al-Mu'minun",
        suraNameAR: "المؤمنون",
        versesNumber: "118 Verses"),
    SuraDataModel(
        id: "24",
        suraNameEN: "An-Nur",
        suraNameAR: "النور",
        versesNumber: "64 Verses"),
    SuraDataModel(
        id: "25",
        suraNameEN: "Al-Furqan",
        suraNameAR: "الفرقان",
        versesNumber: "77 Verses"),
    SuraDataModel(
        id: "26",
        suraNameEN: "Ash-Shu'ara",
        suraNameAR: "الشعراء",
        versesNumber: "227 Verses"),
    SuraDataModel(
        id: "27",
        suraNameEN: "An-Naml",
        suraNameAR: "النمل",
        versesNumber: "55 Verses"),
    SuraDataModel(
        id: "28",
        suraNameEN: "Al-Qasas",
        suraNameAR: "القصص",
        versesNumber: "88 Verses"),
    SuraDataModel(
        id: "29",
        suraNameEN: "Al-Ankabut",
        suraNameAR: "العنكبوت",
        versesNumber: "69 Verses"),
    SuraDataModel(
        id: "30",
        suraNameEN: "Ar-Rum",
        suraNameAR: "الروم",
        versesNumber: "60 Verses"),
    SuraDataModel(
        id: "31",
        suraNameEN: "Luqman",
        suraNameAR: "لقمان",
        versesNumber: "34 Verses"),
    SuraDataModel(
        id: "32",
        suraNameEN: "As-Sajda",
        suraNameAR: "السجدة",
        versesNumber: "30 Verses"),
    SuraDataModel(
        id: "33",
        suraNameEN: "Al-Ahzab",
        suraNameAR: "الأحزاب",
        versesNumber: "73 Verses"),
    SuraDataModel(
        id: "34",
        suraNameEN: "Saba",
        suraNameAR: "سبأ",
        versesNumber: "54 Verses"),
    SuraDataModel(
        id: "35",
        suraNameEN: "Fatir",
        suraNameAR: "فاطر",
        versesNumber: "45 Verses"),
    SuraDataModel(
        id: "36",
        suraNameEN: "Ya-Sin",
        suraNameAR: "يس",
        versesNumber: "83 Verses"),
    SuraDataModel(
        id: "37",
        suraNameEN: "As-Saffat",
        suraNameAR: "الصافات",
        versesNumber: "182 Verses"),
    SuraDataModel(
        id: "38",
        suraNameEN: "Sad",
        suraNameAR: "ص",
    ...
    SuraDataModel(
        ...
        suraNameAR: "الشورى",
        versesNumber: "53 Verses"),
    SuraDataModel(
        id: "43",
        suraNameEN: "Az-Zukhruf",
        suraNameAR: "الزخرف",
        versesNumber: "89 Verses"),
    SuraDataModel(
        id: "44",
    ...
    SuraDataModel(
        ...
        suraNameAR: "الجاثية",
        versesNumber: "37 Verses"),
    SuraDataModel(
        id: "46",
        suraNameEN: "Al-Ahqaf",
        suraNameAR: "الأحقاف",
        versesNumber: "35 Verses"),
    SuraDataModel(
        id: "47",
        suraNameEN: "Muhammad",
        suraNameAR: "محمد",
        versesNumber: "38 Verses"),
    SuraDataModel(
        id: "48",
        suraNameEN: "Al-Fath",
        suraNameAR: "الفتح",
        versesNumber: "29 Verses"),
    SuraDataModel(
        id: "49",
        suraNameEN: "Al-Hujurat",
        suraNameAR: "الحجرات",
        versesNumber: "18 Verses"),
    SuraDataModel(
        id: "50",
        suraNameEN: "Qaf",
        suraNameAR: "ق",
    ...
    SuraDataModel(
        ...
        suraNameEN: "At-Tur",
        suraNameAR: "الطور",
        versesNumber: "49 Verses"),
    SuraDataModel(
        id: "53",
        suraNameEN: "An-Najm",
        suraNameAR: "النجم",
        versesNumber: "62 Verses"),
    SuraDataModel(
        id: "54",
        suraNameEN: "Al-Qamar",
        suraNameAR: "القمر",
    ...
    SuraDataModel(
        ...
        suraNameAR: "المجادلة",
        versesNumber: "22 Verses"),
    SuraDataModel(
        id: "59",
        suraNameEN: "Al-Hashr",
        suraNameAR: "الحشر",
        versesNumber: "24 Verses"),
    SuraDataModel(
        id: "60",
        suraNameEN: "Al-Mumtahina",
        suraNameAR: "الممتحنة",
        versesNumber: "13 Verses"),
    SuraDataModel(
        id: "61",
        suraNameEN: "As-Saff",
        suraNameAR: "الصف",
        versesNumber: "14 Verses"),
    SuraDataModel(
        id: "62",
        suraNameEN: "Al-Jumu'a",
        suraNameAR: "الجمعة",
        versesNumber: "11 Verses"),
    SuraDataModel(
        id: "63",
    ...
    SuraDataModel(
        ...
        suraNameAR: "المعارج",
        versesNumber: "44 Verses"),
    SuraDataModel(
        id: "71",
        suraNameEN: "Nuh",
        suraNameAR: "نوح",
        versesNumber: "28 Verses"),
    SuraDataModel(
        id: "72",
        suraNameEN: "Al-Jinn",
        suraNameAR: "الجن",
    ...
    SuraDataModel(
        ...
        suraNameAR: "المزمل",
        versesNumber: "20 Verses"),
    SuraDataModel(
        id: "74",
        suraNameEN: "Al-Muddathir",
        suraNameAR: "المدثر",
        versesNumber: "56 Verses"),
    SuraDataModel(
        id: "75",
        suraNameEN: "Al-Qiyama",
        suraNameAR: "القيامة",
        versesNumber: "40 Verses"),
    SuraDataModel(
        id: "76",
        suraNameEN: "Al-Insan",
        suraNameAR: "الإنسان",
        versesNumber: "31 Verses"),
    SuraDataModel(
        id: "77",
        suraNameEN: "Al-Mursalat",
        suraNameAR: "المرسلات",
        versesNumber: "50 Verses"),
    SuraDataModel(
        id: "78",
        suraNameEN: "An-Naba",
        suraNameAR: "النبأ",
    ...
    SuraDataModel(
        ...
        suraNameAR: "النازعات",
        versesNumber: "46 Verses"),
    SuraDataModel(
        id: "80",
        suraNameEN: "Abasa",
        suraNameAR: "عبس",
        versesNumber: "42 Verses"),
    SuraDataModel(
        id: "81",
    ...
    SuraDataModel(
        ...
        suraNameAR: "الإنفطار",
        versesNumber: "19 Verses"),
    SuraDataModel(
        id: "83",
        suraNameEN: "Al-Mutaffifin",
        suraNameAR: "المطففين",
        versesNumber: "36 Verses"),
    SuraDataModel(
        id: "84",
        suraNameEN: "Al-Inshiqaq",
        suraNameAR: "الإنشقاق",
        versesNumber: "25 Verses"),
    SuraDataModel(
        id: "85",
        suraNameEN: "Al-Buruj",
        suraNameAR: "البروج",
    ...
    SuraDataModel(
        ...
        suraNameAR: "الشمس",
        versesNumber: "15 Verses"),
    SuraDataModel(
        id: "92",
        suraNameEN: "Al-Lail",
        suraNameAR: "الليل",
        versesNumber: "21 Verses"),
    SuraDataModel(
        id: "93",
        suraNameEN: "Ad-Duha",
        suraNameAR: "الضحى",
    ...
    SuraDataModel(
        ...
        suraNameEN: "Al-Asr",
        suraNameAR: "العصر",
        versesNumber: "3 Verses"),
    SuraDataModel(
        id: "104",
        suraNameEN: "Al-Humazah",
        suraNameAR: "الهمزة",
        versesNumber: "9 Verses"),
    SuraDataModel(
        id: "105",
        suraNameEN: "Al-Fil",
        suraNameAR: "الفيل",
  ...
  void _removeRecentItem(int index) {
    setState(() {
      recentDataList.removeAt(index);
    });
  }
              ...
              children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            onTap: () => _removeRecentItem(index),
                            child: Icon(
                              Icons.delete,
                              color: AppColors.blackColor.withOpacity(.80),
                              size: 30,
                            ),
                          ),
                        ),
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    ...
                    child:
                        SuraItemWedget(suraDataModel: filteredSuraList[index]),
                  ),
